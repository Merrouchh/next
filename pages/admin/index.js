      ...
      <div className={styles.adminDashboard}>
        ...
        <section className={styles.computersSection}>
          ...
          {stats.activeSessions.length === 0 && !stats.loading && sessionViewMode === 'list' ? (
            ...
            <div className={styles.sessionsRedirect}>
              <div className={styles.redirectMessage}>
                <h3>View detailed computer status in the Sessions page</h3>
                <p>The full computer grid view has been moved to the dedicated Sessions page for better organization.</p>
                <button 
