      ...
      <div className={styles.dashboardHeader}>
        <div className={styles.topNav}>
          <div className={styles.navContainer}>
            {(isMobile ? topNavigationItems : [...topNavigationItems, ...bottomNavigationItems]).map((item, _index) => (
              <button
                key={item.key}
                data-path={item.path}
        ...
        {/* Only show bottom nav in mobile */}
        {isMobile && (
          <div className={styles.bottomNav}>
            <div className={styles.navContainer}>
              {bottomNavigationItems.map((item, _index) => (
                <button
                  key={item.key}
                  data-path={item.path}
                  className={`${styles.navButton} ${isActive(item.path) ? styles.active : ''}`}
